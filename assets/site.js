...
(function () {
  ...
  if (nav) nav.innerHTML =
    ...
    '<div class="nav-desktop" style="display:none;align-items:center;gap:.25rem">' +
      ...
      '<a class="nav-link" href="https://gnycyouth.org/shop/">Store</a>' +
    '</div>' +
    ...
    '<div id="mobile-menu" class="m-menu" hidden>' +
      ...
      '<a href="https://gnycyouth.org/shop/">Store</a><a class="btn-primary" style="justify-content:center;margin-top:.5rem" href="' + CONGRESS + '">Register for AY Congress XVIII</a>' +
    '</div></div></nav>' +
  ...
  if (foot) foot.innerHTML =
    ...
    '<div style="display:flex;gap:.75rem;margin-top:1.5rem"><a class="soc" href="https://www.instagram.com/gnycyouth/" aria-label="Instagram"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><rect x="3.5" y="3.5" width="17" height="17" rx="4.8"/><circle cx="12" cy="12" r="4"/><circle cx="17.2" cy="6.8" r="1" fill="currentColor" stroke="none"/></svg></a><a class="soc" href="https://www.facebook.com/GNYCYouth/" aria-label="Facebook"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 21v-7.5h2.6l.4-3h-3V8.6c0-.9.3-1.5 1.6-1.5h1.5V4.4c-.3 0-1.2-.1-2.2-.1-2.2 0-3.7 1.3-3.7 3.8v2.4H8.2v3h2.5V21z"/></svg></a><a class="soc" href="https://www.youtube.com/@gnyc_youth" aria-label="YouTube"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M21.6 7.2a2.5 2.5 0 0 0-1.8-1.8C18.2 5 12 5 12 5s-6.2 0-7.8.4A2.5 2.5 0 0 0 2.4 7.2 26 26 0 0 0 2 12a26 26 0 0 0 .4 4.8 2.5 2.5 0 0 0 1.8 1.8C5.8 19 12 19 12 19s6.2 0 7.8-.4a2.5 2.5 0 0 0 1.8-1.8A26 26 0 0 0 22 12a26 26 0 0 0-.4-4.8zM10 15V9l5.2 3z"/></svg></a><a class="soc" href="https://www.tiktok.com/@gnycyouth" aria-label="TikTok"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.6 5.8a4.3 4.3 0 0 1-1-2.8h-3v12.4a2.6 2.6 0 1 1-2.6-2.7c.3 0 .5 0 .8.1V9.7a5.7 5.7 0 1 0 4.9 5.7V9.1a7.3 7.3 0 0 0 4.2 1.3v-3a4.3 4.3 0 0 1-3.3-1.6z"/></svg></a></div></div>' +
